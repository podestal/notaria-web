...
const IngresoCard = ({
    ...
    const canAnular = !ingreso.anulada
    const canCanjear = !ingreso.anulada && !ingreso.canjeada
    ...
    return (
        ...
        >
                ...
                <dl className="mt-3 grid grid-cols-2 gap-x-4 gap-y-1 border-t border-slate-100 pt-3 text-[11px] sm:grid-cols-4">
                    <div>
                        ...
                        <dd className="font-medium text-slate-800">
                            {formatLocalDate(ingreso.fecha_emision)}
                        </dd>
                    </div>
                    <div>
            ...
            <div className="grid grid-cols-3 gap-1 border-t border-slate-100 bg-slate-50/80 px-2 py-2">
                <ActionButton
                    label="Imprimir"
