            ...
            <>
                <KardexFormTabs 
                    tabs={[
                        ...
                        { id: 'escrituración', label: 'Información del Bien', content: <>{kardex.idtipkar === 3 ? <VehicleMain kardex={kardex.kardex} idtipoacto={patrimonial.idtipoacto} /> : <DetalleBienMain kardex={kardex.kardex}/>}</>},
                    ]}
                />
