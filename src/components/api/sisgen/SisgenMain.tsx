    ...
    <div className="mt-[80px] w-[85%] h-screen mx-auto bg-slate-100 rounded-lg shadow-lg mb-10 text-black flex flex-col items-center justify-start">
        <KardexFormTabs 
            tabs={[
                ...
                { id: 'transferencias', label: 'Transferencias', content: <SisgenBody typekardex="Transferencias Vehiculares" instrumentType={2} /> },
                { id: 'garantias', label: 'Garantías', content: <SisgenBody typekardex="Garantías Inmobiliarias" instrumentType={3} /> },
                { id: 'no-contenciosos', label: 'No Contenciosos', content: <SisgenBody typekardex="No Contenciosos" instrumentType={4} /> },
